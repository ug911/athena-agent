...
format: INPUTFORMAT
partition_keys: []
last_synced: '2026-04-28T07:05:33+00:00'
sampled_rows: 0
---

# `backend.wise_app_backend__announcements`
...
```sql
CREATE EXTERNAL TABLE `backend.wise_app_backend__announcements`(
...
TBLPROPERTIES (
  ...
  'transient_lastDdlTime'='1626548235')
```
