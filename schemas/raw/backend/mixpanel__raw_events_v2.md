...
- month
- day
last_synced: '2026-04-28T07:04:33+00:00'
sampled_rows: 0
---

# `backend.mixpanel__raw_events_v2`
...
```sql
CREATE EXTERNAL TABLE `backend.mixpanel__raw_events_v2`(
...
TBLPROPERTIES (
  ...
  'transient_lastDdlTime'='1629352433')
```
