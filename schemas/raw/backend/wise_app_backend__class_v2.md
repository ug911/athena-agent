---
database: backend
table: wise_app_backend__class_v2
type: table
layer: raw
location: s3://[REDACTED-BUCKET]/production/wise-app-backend/class
format: INPUTFORMAT
partition_keys: []
last_synced: '2026-04-28T07:06:03+00:00'
sampled_rows: 0
---

# `backend.wise_app_backend__class_v2`
...
```sql
CREATE EXTERNAL TABLE `backend.wise_app_backend__class_v2`(
...
TBLPROPERTIES (
  ...
  'transient_lastDdlTime'='1650087365')
```
