---
canonical: backend
table: wise_app_backend__user_v2_2007
type: table
layer: raw
regions:
  na: backend_na
...
last_synced: '2026-08-11T13:12:52+00:00'
sampled_rows: 0
sampled_region: null
---

# `backend.wise_app_backend__user_v2_2007`
...
```sql
CREATE EXTERNAL TABLE `backend_na.wise_app_backend__user_v2_2007`(
...
TBLPROPERTIES (
  ...
  'transient_lastDdlTime'='1785415683')
```
