...
type: table
layer: raw
location: s3://[REDACTED-BUCKET]/production/wise-app-backend/teacher_leave
format: INPUTFORMAT
partition_keys: []
last_synced: '2026-04-28T07:09:07+00:00'
sampled_rows: 0
---

# `backend.wise_app_backend__teacher_leave`
...
| `reason` | `string` | from deserializer |
...
```sql
CREATE EXTERNAL TABLE `backend.wise_app_backend__teacher_leave`(
...
LOCATION
  's3://[REDACTED-BUCKET]/production/wise-app-backend/teacher_leave'
TBLPROPERTIES (
  'compressionType'='gzip', 
  'transient_lastDdlTime'='1709549940')
```
