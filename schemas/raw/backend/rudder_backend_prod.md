---
database: backend
table: rudder_backend_prod
type: table
layer: raw
location: s3://[REDACTED-BUCKET]/production/primary/rudder-logs/1yqdEtRqmQvQgv2JviZC2RAypww
format: INPUTFORMAT
partition_keys:
- dt
last_synced: '2026-04-28T07:04:37+00:00'
sampled_rows: 0
---

# `backend.rudder_backend_prod`
...
```sql
CREATE EXTERNAL TABLE `backend.rudder_backend_prod`(
...
LOCATION
  's3://[REDACTED-BUCKET]/production/primary/rudder-logs/1yqdEtRqmQvQgv2JviZC2RAypww'
TBLPROPERTIES (
  'case.insensitive'='false', 
  'has_encrypted_data'='false', 
  'last_modified_by'='hadoop', 
  'last_modified_time'='1690796634', 
  'transient_lastDdlTime'='1690796634')
```
