---
canonical: processed
table: wise_app_backend__user_2207
type: table
layer: processed
regions:
  na: processed_na
...
last_synced: '2026-08-11T13:29:14+00:00'
sampled_rows: 200
sampled_region: na
---

# `processed.wise_app_backend__user_2207`
...
```sql
CREATE EXTERNAL TABLE `processed_na.wise_app_backend__user_2207`(
  `_id` string, 
  `namespace` string, 
  `isadmin` string, 
  `activesessions` string, 
...
TBLPROPERTIES (
  ...
  'totalSize'='-1', 
  'transactional'='false', 
  'transient_lastDdlTime'='1785416017', 
